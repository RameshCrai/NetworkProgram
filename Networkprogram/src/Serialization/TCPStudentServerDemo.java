...
public class TCPStudentServerDemo {
	...
	public static void processClientRequest(Socket clientSocket) throws IOException {
		...
		try {
			...
			/**
			 * APPROACH 1 parsing using the first approach: using toString() difficult to
			 * parse - depends on the format of toString()
			 **/

			/**
			 * APPROACH 2 parsing using the second approach: using JSON format much easier
			 * to parse, universal format
			 **/
			Gson gson = new Gson();
	...
	public static void processClientRequestHTML(Socket clientSocket) throws IOException {
		...
		output.write(("HTTP/1.1 200 OK\n\n<html><body>" + "Singlethreaded Server: " + time
