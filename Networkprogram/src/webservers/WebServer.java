...
public class WebServer {
	...
	public static void processClientRequestHTML(Socket clientSocket) throws IOException {
		...
		String htmlMessage = "HTTP/1.1 200 OK\n\n<html>" + "<body>" + "<h1> Java Programming Workshop Series </h1>"
				+ "<h2> Networking Programming with Java</h2>" + "<h3>Presented by: Dr. Anis Koubaa</h3>"
				+ "<p> This is an example of a Web server with Java </p>" + "<p>The current server time is <b>" + time
				+ "</b></p>" + "</body>" + "</html>";
